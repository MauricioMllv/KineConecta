    ...
    return (
      <div className="bg-white border border-slate-300 p-0.5 m-4 shadow-xl rounded-md md:w-[300px] sm:flex sm:flex-col sm:items-center">
        <section className='flex flex-col justify-center bg-[#e4e4e4]'>
          ...
          <button type="button" onClick={() => deleteImages(images.id)} className="px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:bg-red-600">Eliminar</button>
          </section>
        </section>
